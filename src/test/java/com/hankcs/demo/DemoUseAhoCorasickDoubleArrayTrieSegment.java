...
public class DemoUseAhoCorasickDoubleArrayTrieSegment
{
    public static void main(String[] args) throws IOException
    {
        ...
        AhoCorasickDoubleArrayTrieSegment segment = new AhoCorasickDoubleArrayTrieSegment(HanLP.Config.CustomDictionaryPath[1]);
        System.out.println(segment.seg("1.220kV 小开Ⅰ回线293断路器液压操作机构检修，220kV 小开Ⅰ回线2933隔离开关检修，220kV 小开Ⅰ回线线路主一、主二保护装置定检及传动试验；2.220kV 小开Ⅱ回线294断路器液压操作机构检修，220kV 小开Ⅱ回线2943隔离开关检修，220kV 小开Ⅱ回线线路主一、主二保护装置定检及传动试验。"));
    }
}
